...
def compute_accuracy(y_true, y_pred):
    """Compute the best accuracy after aligning cluster labels."""
    # Create a cost matrix where cost[i, j] is the number of points with true label i and predicted label j
